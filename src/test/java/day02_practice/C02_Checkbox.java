...
public class C02_Checkbox {
    ...
    public void test() {
        ...
        Assert.assertTrue(checkBox1.isSelected());//checkbox secilimi -->> evet secili yani true
        Assert.assertTrue(checkBox3.isSelected());//checkBox3.isSelected()=true,,Assert.assertTrue=beklenende true

        // checkbox2 elementinin secili olmadıgını test edin
         Assert.assertFalse(checkBox2.isSelected());//checkbox2 secili degil
