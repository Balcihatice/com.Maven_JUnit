    ...
    */
    ...
    public void test() {
        ...
        firstName.sendKeys(faker.name().firstName(), Keys.TAB,
                ...
                faker.internet().emailAddress(), Keys.TAB, Keys.SPACE, Keys.TAB,
        ...
        // String dosyaYolu = "/Users/haticebalci/Downloads";

        String anayol = System.getProperty("user.home");//     /Users/haticebalci/Downloads
        String ortakYol = System.getProperty("/Desktop/logo.jpg");
